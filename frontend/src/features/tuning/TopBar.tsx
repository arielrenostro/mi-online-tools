...
export default function TopBar({ onLogsClick, onSettingsClick }: Props) {
  ...
  return (
    <header className="flex items-center justify-between px-5 py-3 bg-gray-900 border-b border-gray-700 flex-shrink-0">
      <div className="flex items-center gap-3">
        <span className="text-lg font-bold text-blue-400 tracking-tight">MI Fuel Tuner</span>
        {mapName && (
